...
public class DefaultMessage {
    ...
    private final Smartycountrepo srepo;
   
    @Autowired
    public DefaultMessage(RestTemplate restTemplate, Configvalues values,Currentpatientsrepo app,MessagestatusRepo repo,Smartycountrepo srepo) {
    ...
    private void sendRequestToApi(String phoneNumber) {
        ...
        try {
            ...
            stat.setIsvalidWhatsAppNumber(Boolean.getBoolean(numbervalid));
